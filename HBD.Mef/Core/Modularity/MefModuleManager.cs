...
namespace HBD.Mef.Core.Modularity
{
    ...
    {
        [Import(AllowRecomposition = false)] private MefFileModuleTypeLoader _mefFileModuleTypeLoader;
        ...
        public override IEnumerable<IModuleTypeLoader> ModuleTypeLoaders
        {
            get
            {
                return _mefTypeLoaders ?? (_mefTypeLoaders = new List<IModuleTypeLoader> {_mefFileModuleTypeLoader});
            }
